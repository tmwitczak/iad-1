	...
	\subsection{Zbiór irysów}
	{
		...
		\subsubsection{Algorytm gazu neuronowego}
		{
			...
			Poniżej wykresy dla trzech trybów
				\begin{figure}[!htbp]
					\centering
					\includegraphics[width=\textwidth,width=95mm]{wykresy/}
					\caption{Tryb domyślny danych}
				\end{figure}
	...
	\subsection{Zbiór win}
	{
		...
		\subsubsection{Algorytm Kohonena}
		{
			Poniżej wykresy dla trzech trybów
				\begin{figure}[!htbp]
					\centering
					\includegraphics[width=\textwidth,width=95mm]{wykresy/plot_kohonenWineDefault.png}
					\caption{Tryb domyślny danych}
				\end{figure}
			
				\begin{figure}[!htbp]
					\centering
					\includegraphics[width=\textwidth,width=95mm]{wykresy/plot_kohonenWineNormalised.png}
					\caption{Tryb normalizacji danych}
				\end{figure}
